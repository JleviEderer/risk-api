...
@responses.activate
def test_analyze_trading_toggle_response_warns_even_when_score_is_safe(client):
...
@responses.activate
def test_analyze_whitelist_and_cooldown_toggle_response_warns_even_when_score_is_safe(client):
