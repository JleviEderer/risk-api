...
- Next exact tasks:
  ...
  2. Codex/user: after review, run paid WETH approve smoke, paid snapshot row check, and paid MCP smoke if credentials/funds are available.
