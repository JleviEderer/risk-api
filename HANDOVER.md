...
- Next exact tasks:
  1. Recheck CDP/Bazaar on the next support-response window or after 2026-07-09.
  2. Monitor post-A-003 paid rows using `paid_response_snapshots` and decide whether `L-002` needs facilitator IDs/tx hashes or whether off-chain Blockscout correlation is enough.
  3. Decide the pricing test by 2026-07-20.
