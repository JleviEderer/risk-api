...
> Status: IMPLEMENTED AND DEPLOYED — A-003 response-shape implementation completed 2026-07-08; CI/Fly deploy and live non-paid checks passed; paid smoke checks pending credentials.
