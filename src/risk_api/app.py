...
<div class="detectors">
  ...
  <div class="detector"><div class="name">Deployer Reputation</div><div class="desc">Explorer-backed deployer history</div></div>
</div>
</div>
...
INTENT_PAGES: dict[str, dict[str, object]] = {
    "/honeypot-detection-api": {
        ...
        "check_points": [
            ...
            "Deployer reputation context from explorer-backed history checks.",
        ],
    },
    "/proxy-risk-api": {
    ...
    "/deployer-reputation-api": {
        ...
        "summary": (
            ...
            "reputation detector adds explorer-backed context so an agent can weigh "
        ...
        "check_points": [
            "Deployer reputation signals gathered through the existing explorer-backed path.",
...
8. **Deployer Reputation** - adds deployer-history context when explorer-backed data is available.
                ...
                },
                {
                    ...
                    "acceptedAnswer": {
                        ...
                        "text": (
                            ...
                            "and deployer wallet reputation via an explorer-backed path."
                        ),
                    },
                },
                {
